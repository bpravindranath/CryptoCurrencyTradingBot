...
div
  .mx1
    ...
    span.exchange_Info.exchange_underline(for='exchangeInfo') {{exchangeInfo}}
    span 
      a.exchange_Info(v-bind:href="url",target="_blank", style="font-size: 0.9rem") Their Website
  ...
  computed: {
    ...
    watchConfig: function() {
      ...
      if (this.exchange==='poloniex'){
         this.exchangeInfo= ' For More Details about Poloniex Exchange Visit '
         this.url = 'https://poloniex.com/exchange#btc_eth'
      }else if(this.exchange==='kraken'){
        this.exchangeInfo= ' For More Information About Kraken Exchange Visit '
        this.url = 'https://www.kraken.com/charts'
      } else if(this.exchange==='bitfinex'){
         this.exchangeInfo= ' For More Information About Bitfinex Exchange Visit '
         this.url = 'https://www.bitfinex.com'
      }else if(this.exchange==='bitstamp'){
         this.exchangeInfo= ' For More Information About Bitstamp Exchange Visit '
         this.url = 'https://www.bitstamp.net'
      }else if(this.exchange==='bittrex'){
         this.exchangeInfo= ' For More Information About Bittrex Exchange Visit '
         this.url = 'https://bittrex.com/home/markets'
      }else if(this.exchange==='bitx'){
         this.exchangeInfo= ' For More Information About Bitx Exchange Visit '
         this.url = 'https://www.luno.com/en/price'
      }else if(this.exchange==='btc-markets'){
         this.exchangeInfo= ' For More Information About BTC-Markets Exchange Visit '
         this.url = 'https://www.btcmarkets.net/'
      }else if(this.exchange==='btcc'){
         this.exchangeInfo= ' For More Information About BTCC Exchange Visit '
         this.url = 'https://exchange.btcc.com/trade/btcusd/basic'
      }else if(this.exchange==='bx.in.th'){
         this.exchangeInfo= ' For More Information About Bx.In.Th Exchange Visit '
         this.url = 'https://bx.in.th/'
      }else if(this.exchange==='cexio'){
         this.exchangeInfo= ' For More Information About Cexio Exchange Visit '
         this.url = 'https://cex.io/btc-usd'
      }else if(this.exchange==='gdax'){
         this.exchangeInfo= ' For More Information About Gdax Exchange Visit '
         this.url = 'https://www.gdax.com/trade/BTC-USD'
      }else if(this.exchange==='lakebtc'){
         this.exchangeInfo= ' For More Information About LakeBTC Exchange Visit '
         this.url = 'https://www.lakebtc.com/'
      }else if(this.exchange==='okcoin'){
         this.exchangeInfo= ' For More Information About OkCoin Exchange Visit '
         this.url = 'https://www.okcoin.com/'
      }else if(this.exchange==='wex.nz'){
         this.exchangeInfo= ' For More Information About Wex.nz Exchange Visit '
         this.url = 'https://wex.nz/'
      }else if(this.exchange==='zaif.jp'){
         this.exchangeInfo= ' For More Information About Zaif.jp Exchange Visit '
